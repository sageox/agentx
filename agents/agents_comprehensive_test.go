...
func allAgentSpecs() []agentSpec {
	return []agentSpec{
		...
		},
		{
			...
			capabilities:    agentx.Capabilities{Hooks: true, MCPServers: true, SystemPrompt: true, ProjectContext: true, CustomCommands: false, Rules: true},
			binaryName:      "cursor",
		...
		},
		{
			...
			capabilities:    agentx.Capabilities{Hooks: true, MCPServers: false, SystemPrompt: true, ProjectContext: true, CustomCommands: false, Rules: true},
			binaryName:      "windsurf",
		...
		},
		{
			...
			isLifecycleAgent: true,
			envAliases:       []string{"pi", "pi-coding-agent"},
			eventPhaseCount:  5,
		},
		{
			name:            "Cline",
